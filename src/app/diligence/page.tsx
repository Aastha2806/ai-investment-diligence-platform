...
export default function DiligencePage() {
  ...
  return (
    <div>
      <PageHeader
        eyebrow="Diligence"
        title="AI-Assisted Diligence Engine"
        description="Structured findings generated by deterministic rules over the historical financials, forensic metrics, DCF sensitivity, and management commentary — not by a language model. Each finding cites the metric that triggered it."
      />
      <IllustrativeBanner />
